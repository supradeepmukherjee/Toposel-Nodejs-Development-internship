...
const registrationValidator = () => [
    ...
    body('fullName', 'Please Enter Username').notEmpty(),
    body('country', 'Please Enter Username').notEmpty(),
    body('password', 'Please Enter Password of Minimum 8 Characters').notEmpty().isLength({ min: 8 }),
...
const searchValidator = () => [
    ...
    body('email').if(body('searchBy').equals('email')).notEmpty().isEmail().withMessage('Invalid email address.'),
